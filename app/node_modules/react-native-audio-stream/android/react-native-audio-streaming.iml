...
<module external.linked.project.id=":react-native-audio-streaming" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../Example/android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7" inherit-compiler-output="false">
    ...
    <orderEntry type="library" exported="" name="aacdecoder-android-0.8" level="project" />
